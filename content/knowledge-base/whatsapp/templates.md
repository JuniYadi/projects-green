...
2. **Configure Your Content**: 
   ...
   - Add optional **Quick Reply** or **Call-to-Action** buttons (like *"Track Order"* or *"Copy Code"*).
...
*Use for:* Informing a customer about an ongoing transaction or account action they specifically requested.
...
- **The Issue**: Submitting a template as `UTILITY` that contains words like *"discount"*, *"free trial"*, *"recommended for you"*, *"cashback"*, *"coupon"*, or promo links.
...
- **The Issue**: Mentioning unauthorized pharmaceuticals, gambling, unverified loans, or misleading threats (*"Your account will be deleted in 5 minutes unless you click here"*).
...
1. **Discounts & Upsells**: Any mention of sales, vouchers, coupons, or cross-selling (*"Would you also like to try our Pro tier?"*).
2. **Promotional Greetings**: Proactive welcome messages pointing to a product catalog.
3. **Surveys & Reviews**: Post-purchase requests for star ratings or Google reviews (*"How was your purchase? Rate us here!"*).
