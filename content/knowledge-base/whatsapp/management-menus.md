...
howTo:
  - "Configure and pair WhatsApp devices in Devices (/console/whatsapp/devices)."
  - "Run targeted broadcast campaigns in Broadcasts (/console/whatsapp/broadcasts)."
  - "Organize customer address books and audience segments in Contacts (/console/whatsapp/contacts)."
  - "Integrate product catalogs for in-chat commerce in Catalogs (/console/whatsapp/catalogs)."
  - "Monitor consumption, financial accounting, and pricing in Usage, Ledger, and Pricing menus."
notes:
  - "Phone numbers connected via QR code or Meta Cloud Tokens appear under Devices."
  - "Failed message deliveries automatically refund consumed balance to the organizational ledger."
---

# WhatsApp Console Management Modules

This reference document covers all operational management modules in the WhatsApp Console sidebar.
