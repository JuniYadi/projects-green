...
howTo:
  - "Konfigurasikan dan hubungkan perangkat WhatsApp di menu Perangkat (/console/whatsapp/devices)."
  - "Kirim kampanye pesan siaran massal bertarget di menu Broadcasts (/console/whatsapp/broadcasts)."
  - "Kelola buku alamat pelanggan dan segmen kontak di menu Kontak (/console/whatsapp/contacts)."
  - "Integrasikan katalog produk untuk belanja di WhatsApp di menu Katalog (/console/whatsapp/catalogs)."
  - "Pantau volume pemakaian, mutasi saldo, dan daftar tarif di menu Penggunaan, Buku Besar, dan Harga."
notes:
  - "Nomor WhatsApp yang terhubung melalui scan QR code atau Meta Cloud Token akan muncul pada menu Perangkat."
  - "Pengiriman pesan yang gagal secara otomatis mengembalikan saldo kuota (auto-refund) ke buku besar organisasi."
---

# Modul Manajemen WhatsApp Console

Dokumentasi referensi ini merangkum seluruh modul operasional dan fungsionalitas menu manajemen pada sidebar WhatsApp Console.
