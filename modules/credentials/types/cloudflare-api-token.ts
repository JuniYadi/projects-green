...
export type CloudflareApiTokenMetadata = z.infer<
  typeof cloudflareApiTokenMetadataSchema
>

export const cloudflareApiTokenSecretsSchema = z.object({
  token: z.string().min(10),
})
export type CloudflareApiTokenSecrets = z.infer<
  typeof cloudflareApiTokenSecretsSchema
>
