...
export type CloudflareLegacyTokenMetadata = z.infer<
  typeof cloudflareLegacyTokenMetadataSchema
>
...
export type CloudflareLegacyTokenSecrets = z.infer<
  typeof cloudflareLegacyTokenSecretsSchema
>
...
export const CloudflareLegacyTokenDef = {
  ...
  icon: "Key",
  metadataFields: [{ key: "tokenFormat", label: "Token Format" }] as const,
