      ...
      async ({ body, set }) => {
        ...
        try {
          ...
          if (paymentMethod === "MANUAL_BANK") {
            const accounts =
              await bankAccountService.getActiveAccounts(currency)
          ...
          if (paymentMethod === "VA" || paymentMethod === "QRIS") {
            ...
            if (!gateway) {
              ...
              return {
                ...
                message: `Gateway is not available for ${currency}. Please choose another payment method.`,
              }
            }
          ...
          if (paymentMethod === "VA" || paymentMethod === "QRIS") {
            ...
            try {
              ...
              // Roll back the topup invoice so failed attempts do not leave orphaned open invoices
