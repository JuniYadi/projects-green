      ...
      .post(
        ...
        },
        {
          detail: {
            ...
            description:
              "Exchange WorkOS OAuth authorization code for a mobile session JWT token. Returns user info, subscription status, and device registration.",
          },
          body: t.Object({
      ...
      .post(
        ...
        },
        {
          detail: {
            ...
            description:
              "Authenticate using a subscription ID directly (paired via QR flow). Returns session token, subscription info, and available VPN profiles.",
          },
          body: t.Object({
      ...
      .post(
        ...
        },
        {
          detail: {
            ...
            description:
              "Deprecated. Returns 410 Gone — obtain a fresh token via POST /vpn/mobile/auth/exchange.",
          },
          body: t.Object({
