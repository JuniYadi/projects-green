...
export const BILLING_RENEWAL_LADDER_QUEUE = "billing-renewal-ladder"
export const BILLING_VOUCHER_EXPIRATION_QUEUE = "billing-voucher-expiration"
export const BILLING_TOPUP_ADMIN_NOTICE_SWEEP_QUEUE =
  "billing-topup-admin-notice-sweep"
...
export const BILLING_RENEWAL_LADDER_JOB = "billing-renewal-ladder-job"
export const BILLING_VOUCHER_EXPIRATION_JOB = "billing-voucher-expiration-job"
export const BILLING_TOPUP_ADMIN_NOTICE_SWEEP_JOB =
  "billing-topup-admin-notice-sweep-job"
