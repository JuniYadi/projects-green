...
export const FEATURE_MAPPINGS: FeatureMapping[] = [
  ...
  },
  {
    ...
    sourcePrefixes: [
      ...
      "app/[lang]/portal/app/stacks/",
      "app/[lang]/portal/app/page-client",
      "modules/admin/api/routes/admin-stacks",
    ...
    testPrefixes: [
      ...
      "modules/admin/api/routes/admin-stacks.route.test.ts",
  ...
  },
  {
    ...
    sourcePrefixes: [
      "app/[lang]/portal/whatsapp/analytics/",
      "modules/whatsapp/analytics/",
    ],
    testPrefixes: [
      "app/[lang]/portal/whatsapp/analytics/",
      "modules/whatsapp/analytics/",
