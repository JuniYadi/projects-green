...
export const WorkflowNodeComponent = memo(function WorkflowNodeComponent({
  ...
  const containerClasses = [
    "group relative max-w-[240px] min-w-[210px] rounded-xl border bg-card",
    "p-3 text-card-foreground shadow-md transition-all dark:bg-card/95",
    "dark:shadow-xl",
    selected
      ? "border-primary ring-2 shadow-primary/20 ring-primary/50"
      : "border-border/90 hover:border-border hover:shadow-lg " +
        "dark:border-border/70 dark:hover:border-zinc-500",
  ].join(" ")

  const handleClasses =
    "!h-2.5 !w-2.5 !rounded-full !border-2 !border-background " +
    "!bg-muted-foreground transition-all group-hover:!bg-primary"
    ...
    <div className={containerClasses}>
      ...
      >
        <div className="flex min-w-0 items-center gap-1.5 overflow-hidden">
          <div
            className={
              ...
              `rounded-md border ${details.color}`
            }
          >
          ...
          <div className="min-w-0">
            ...
            <span
              className={
                "py-0.2 inline-block rounded border px-1 text-[9px] " +
        ...
        {nodeData.onDelete && (
          <button
            ...
            className={
              "shrink-0 rounded p-1 text-muted-foreground opacity-60 " +
      ...
      <div className="mt-1.5 space-y-1">
        {Boolean(nodeData.config?.agentProfileName) && (
          <div
            className={
              "flex items-center gap-1 rounded border border-purple-500/30 " +
              "bg-purple-500/10 px-1.5 py-0.5 text-[9px] font-medium " +
              "text-purple-400"
            }
          >
        ...
        {Boolean(nodeData.config?.captureVariable) && (
          <div
            className={
              "py-0.2 inline-flex items-center gap-1 rounded border " +
              "border-border/40 bg-secondary/80 px-1.5 font-mono " +
              "text-[9px] text-secondary-foreground"
            }
          >
            <span>save:</span>
      ...
      {isCondition ? (
        <>
          ...
          <Handle
            ...
            className={
              "!h-2.5 !w-2.5 !rounded-full !border-2 !border-background " +
              "!bg-emerald-500 transition-transform hover:scale-125"
            }
          />
          ...
          <Handle
            ...
            className={
              "!h-2.5 !w-2.5 !rounded-full !border-2 !border-background " +
              "!bg-rose-500 transition-transform hover:scale-125"
            }
          />
        </>
      ) : (
        <>
          ...
          <Handle
            ...
            className={
              "!h-2.5 !w-2.5 !rounded-full !border-2 !border-background " +
              "!bg-primary transition-all group-hover:scale-125"
            }
          />
