...
export default function SubscriptionPage() {
  ...
  const t = messages.console.billing.singleSubscription
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center gap-2">
            ...
            <CardTitle className="text-base">{t.appHostingTitle}</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center gap-2">
            ...
            <CardTitle className="text-base">{t.vpnTitle}</CardTitle>
          </CardHeader>
          <CardContent>
            {vpnSubs.length > 0 ? (
              <div className="space-y-3">
