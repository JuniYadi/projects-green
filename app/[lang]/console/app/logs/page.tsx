...
export default function LogsPage() {
  ...
  return (
    <LifecyclePageShell
      title={messages.console.app.logs.heading}
      description={messages.console.app.logs.description}
    >
