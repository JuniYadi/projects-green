  ...
  return (
    <div className="flex w-full flex-col gap-10 xl:flex-row xl:items-start xl:gap-12">
      ...
      <div className="min-w-0 flex-1 space-y-10">
        ...
        {/* Prose Markdown Body */}
        <article
          className="prose max-w-none text-foreground dark:prose-invert [&_:not(pre)>code]:rounded-md [&_:not(pre)>code]:border [&_:not(pre)>code]:border-border/60 [&_:not(pre)>code]:bg-muted/70 [&_:not(pre)>code]:px-1.5 [&_:not(pre)>code]:py-0.5 [&_:not(pre)>code]:font-mono [&_:not(pre)>code]:text-[12px] [&_:not(pre)>code]:font-medium [&_:not(pre)>code]:text-foreground [&_:not(pre)>code]:before:content-['']! [&_:not(pre)>code]:after:content-['']! [&_a]:font-medium [&_a]:text-emerald-600 [&_a]:no-underline hover:[&_a]:underline dark:[&_a]:text-emerald-400 [&_blockquote]:my-6 [&_blockquote]:rounded-xl [&_blockquote]:border-l-4 [&_blockquote]:border-emerald-500 [&_blockquote]:bg-card [&_blockquote]:p-4 [&_blockquote]:text-sm [&_blockquote]:text-foreground [&_h2]:mt-12 [&_h2]:mb-4 [&_h2]:scroll-mt-28 [&_h2]:border-b [&_h2]:border-border/50 [&_h2]:pb-2 [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:tracking-tight [&_h2]:text-foreground [&_h3]:mt-8 [&_h3]:mb-3 [&_h3]:scroll-mt-28 [&_h3]:text-lg [&_h3]:font-semibold [&_h3]:tracking-tight [&_h3]:text-foreground [&_li]:my-1.5 [&_li]:text-sm [&_li]:text-muted-foreground [&_ol]:list-decimal [&_ol]:pl-5 [&_table]:my-8 [&_table]:w-full [&_table]:border-collapse [&_table]:overflow-hidden [&_table]:rounded-xl [&_table]:border [&_table]:border-border/60 [&_td]:border-b [&_td]:border-border/40 [&_td]:p-3 [&_td]:text-xs [&_td]:text-muted-foreground [&_th]:border-b [&_th]:border-border/60 [&_th]:bg-muted/40 [&_th]:p-3 [&_th]:text-left [&_th]:text-xs [&_th]:font-semibold [&_th]:text-foreground [&_tr:hover]:bg-muted/20 [&_tr:last-child_td]:border-b-0 [&_ul]:list-disc [&_ul]:pl-5"
